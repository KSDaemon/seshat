...
pub use code_pattern::{
    CodePatternData, PatternRanking, PatternResult, cosine_similarity, query_code_pattern,
    query_code_pattern_ranked, query_code_pattern_with_embeddings,
};
pub use conventions::{
...
pub use dependencies::{
    ...
    ExternalDependency, MAX_DEPENDENTS, MAX_TRANSITIVE_DEPTH, QueryDependenciesOptions,
    query_dependencies, query_dependencies_batch,
};
pub use detection::{DetectionReport, convention_to_node, persist_and_index, run_detection_cycle};
pub use diff_impact::{
    AdoptionSummary, AffectedSymbol, AffectedSymbolsResult, BlastRadiusSummary, ChangedFile,
    ConventionRisk, DependentRef, DiffImpactData, DiffImpactRequest, FileStatus, ImpactMetadata,
    map_diff_impact,
};
