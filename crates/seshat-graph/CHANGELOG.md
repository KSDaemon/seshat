...
## [0.7.2](https://github.com/KSDaemon/seshat/compare/seshat-graph-v0.7.0...seshat-graph-v0.7.2) - 2026-06-18

### <!-- 1 -->Bug Fixes

- *(validate)* raise rule relevance gate to 3 shared tokens

## [0.7.1](https://github.com/KSDaemon/seshat/compare/seshat-graph-v0.7.0...seshat-graph-v0.7.1) - 2026-06-18
...
- *(decisions)* auto-anchor recorded decisions to code snippets
- *(deps)* resolve tsconfig.json path aliases in query_dependencies

### <!-- 1 -->Bug Fixes

- *(graph)* surface relevant conventions in validate_approach
- *(graph)* cap and rank query_code_pattern lookup results
